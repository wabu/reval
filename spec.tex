...
\usepackage{a4}
\usepackage{ngerman}                            % neü Rechtschreibung
...
Karl hört gerade eine Datenbankvorlesung und muss relationale Algebra lernen.
...
\subsection{Required}
\begin{itemize}
\item ADT für Tabelle 
\begin{itemize}
\item Notation für Tabellen bzw. Mengen
\item Notation für atomare Werte
\end{itemize}
\item Support für die sechs Basisoperationen
\begin{itemize}
\item Projektion
\item Selektion
\item Umbenennung
...
\item Differenz
\end{itemize}
\item gute Code Qualität (stabil, les- und wartbar)
\item test-driven-development (nicht-funktional)
\end{itemize}
\subsection{Optinal}
\begin{itemize}
\item ADT für Tabelle 
\item Tabellen mit unterschiedlichen Typen für Spalten
\item gut lesbare ASCII-Art show Funktion für ADT
\end{itemize}
...
\item intuitive nicht-haskell Notation für die rel. Algebra
\end{itemize}
\end{document}
